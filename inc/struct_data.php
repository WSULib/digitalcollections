...
<img src="//<?php echo $APP_HOST; ?>/item/<?php echo $objectPID; ?>/thumbnail/" class="primary-image" itemprop="image">
<meta itemprop="thumbnailUrl" content="http://<?php echo $APP_HOST; ?>/item/<?php echo $objectPID; ?>/thumbnail/">
</div>
<!-- ******************************** -->
