	...
	<div id="search_container" class="container-fluid">
        ...
        <div class="row-fluid" id="search_form">            
            <div class="span4 pull-right">
                <form class="form-search" onsubmit="searchGo(); return false;">                    
                    <input style="height:30px;" class="input-medium search-query" id='q' type='text' value="ford" placeholder="e.g. Detroit"/>
        ...
        <div class="row-fluid">
            <div class="num_results span12">
                ...
                <select style="width:75px;" id='rows'>
