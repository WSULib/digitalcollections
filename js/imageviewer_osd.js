...
function updatePage(){
	...
	// add page navigation if other images present
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// console.log("My DS is",imageParams.DS);
	
	// // strip '_JP2' suffix for dictionary
	// stripped_dsid = imageParams.DS.split("_JP2")[0];
	// console.log(stripped_dsid);

	// var images = APIdata.singleObjectPackage.parts_imageDict.sorted;
	// var c_img = APIdata.singleObjectPackage.parts_imageDict[stripped_dsid];
	// console.log(c_img);

	// var previous_index = c_img['order'] - 1	
	// console.log(previous_index);
	// var next_index = c_img['order'] + 1

	// // previous
	// $("#previous").attr('href','http://digital.library.wayne.edu/dev/graham/digitalcollections/imageviewer_osd.php?PID='+imageParams.PID+'&DS='+images[previous_index]['jp2']);

	// // next
	// $("#next").attr('href','http://digital.library.wayne.edu/dev/graham/digitalcollections/imageviewer_osd.php?PID='+imageParams.PID+'&DS='+images[next_index]['jp2']);
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
