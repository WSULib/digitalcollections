...
function showFacets(){
  ...
  for (var i = 0; i < mergedParams['fq[]'].length; i++){    
    ...
    nURL = URLcleaner(nURL);     
    $(".filtered-by").append("<span class='facet-item'><a href='"+nURL+"'><span class='entypo-minus'></span> "+rosetta(facet_value)+"</a></span>");
  }
}
...
function favObjRemove(PID){    
    if (typeof userData.username_WSUDOR != "undefined"){     
      ...
      var APIaddURL = "/WSUAPI-dev?functions[]=solrRemoveDoc"
