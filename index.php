...
<body class="index-bg">
	...
	<div class="masthead cf masthead-overflowing">
		<div class="slides-wrap">
			<div class="slide photo" id="mh-slide-24956">
			  <img data-pm-sized="yes" src="img/vmc_banner.jpg" alt="Virtual Motor City"></div>
		</div>
	</div>
	...
	<div class="container feature">
		<div class="col-sm-6 col-md-7">
			...
			<h3><a href="/digitalcollections/item?rendered=singleObject&id=wayne:collectionvmc">Virtual Motor City</a></h3>
	...
	<div class="container feature-bottom">
		...
		<div class="col-md-6">
			<h2>Welcome to the WSULS Digital Collections!</h2>
			...
			<h4><a href="/digitalcollections/allcollections.php">Collections</a></h4>
			<h4><a href="/digitalcollections/search.php">Search and Browse</a></h4>
			<h4><a href="/digitalcollections/about.php">About</a></h4>
			<h4><a href="/digitalcollections/contact.php">Contact</a></h4>
